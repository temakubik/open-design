...
- Figma: `https://www.figma.com/design/avkpGs9WYfueKF8XvzT3KG/📥-CRM-маркетинг?node-id=392-25984`
...
- CRM-рассылка, светлая тема — file key `avkpGs9WYfueKF8XvzT3KG`, node `392:25984`.

Decoded Figma snapshots:
- Evidence note: `context/figma/crm-email-light.md`.
- Full node export: `context/figma/crm-email-light/files/node-392-25984.png`.
- Raw node assets: `context/figma/crm-email-light/files/`.
- Reusable reference: `assets/figma-email-light/newsletter-light-reference.png`.
Fonts, logos, and assets selected:
- Untitled.pptx

Uploaded brand asset files under `assets/`:
- assets/Untitled.pptx
